...
<div class="main_box">
    <h2><span></span>公告添加</h2>
    <div class="cont_box">
        <form action="<?php echo U('Notice/notice_editHandle',array('id'=>$data['id']));?>" method="post" id="form">
            <ul class="addpro_box adduser_box">
                <li>
                    <label>公告名称：</label>
                    <input type="text" placeholder="请输入公告名称" name="title" value="<?php echo ($data["title"]); ?>" />
                </li>
                <li>
                    <label>公告内容：</label>
