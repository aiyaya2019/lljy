...
<div class="main_box">
	...
	<div class="cont_box">
		<form action="<?php echo U('Product/product_cate_editHandle',array('id'=>$data['id']));?>" method="post" id="form">
...
<script type="text/javascript">
    var uploader_avatar = new plupload.Uploader({   //创建实例的构造方法
        ...
        url: "<?php echo U('Common/uploadsImg',array('path'=>goods_cate));?>",   //远程上传地址
        filters: {
