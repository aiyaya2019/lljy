	...
	<form action="#" method="get" id="order_shform">
		<div class="search_box clearfix">
			<select name="status" id="status">
				<option value="" <?php if($_GET['status'] == 0): ?>selected<?php endif; ?> >---订单状态---</option>
				<option value="0" <?php if($_GET['status'] == '0'): ?>selected<?php endif; ?> >未支付</option>
				<option value="1" <?php if($_GET['status'] == 1): ?>selected<?php endif; ?> >已支付</option>
			</select>
			<div class="date_box">
				<input type="text" name="keywords" value="<?php echo ($_GET['keywords']); ?>" placeholder="订单号">
			</div>
