...
<div class="main_box">
    ...
    <div class="cont_box">
        <form action="<?php echo U('Banner/banner_edit',array('id'=>$data['id']));?>" method="post" id="form">
            <ul class="addpro_box adduser_box">
                <li>
                    <label>轮播图名称：</label>
                    <input type="text" placeholder="请输入轮播图名称" name="name" value="<?php echo ($data["name"]); ?>" />
                </li>
                <li>
                    <label>跳转链接：</label>
                    <input type="text" placeholder="请输入跳转链接" name="url" value="<?php echo ($data["url"]); ?>" />
                </li>
                <li>
                    <label>图片：</label>
                    <div id="upload_pic">
                        ...
                        <?php else: ?>
                            <img src="<?php echo ($data["pic"]); ?>" class="pic" alt="图片"><?php endif; ?>
                    </div>
...
<script type="text/javascript">
    var uploader_avatar = new plupload.Uploader({   //创建实例的构造方法
        ...
        url: "<?php echo U('Common/uploadsImg',array('path'=>banner));?>",   //远程上传地址
        filters: {
