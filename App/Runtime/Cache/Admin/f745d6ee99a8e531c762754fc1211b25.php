...
<div class="main_box">
    <h2><span></span>vip</h2>
    <div class="cont_box">
        <form action="<?php echo U('Video/vip_edit',array('id'=>$data['id']));?>" method="post" id="form">
            <ul class="addpro_box adduser_box">
                <li>
                    <label>vip名称：</label>
                    <input type="text" placeholder="请输入vip名称" name="name" value="<?php echo ($data["name"]); ?>" />
                </li>
                <li>
                    <label>费用/元：</label>
                ...
                <li>
                    <label>有效期/月：</label>
                    <input type="text" placeholder="请输入有效期" name="term" value="<?php echo ($data["term"]); ?>" />
                </li>
                <li>
                    <label>显示状态：</label>
