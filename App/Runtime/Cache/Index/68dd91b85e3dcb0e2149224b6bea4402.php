    ...
    <div class="bank-index">
    	<ul>
    	    <?php if(is_array($data)): foreach($data as $key=>$v): ?><li add_id="<?php echo ($v["id"]); ?>">
	    			...
	    			<div class="edit">
                        <a href="<?php echo U('Product/address_edit',array('id'=>$v['id'],'type'=>$_GET['type']));?>">
    	...
    	<a class="addbank" href="<?php echo U('Product/address_edit',array('product_id'=>$_GET['product_id']));?>">
    		<img src="/Public/images/addbank.png" alt="">
    		<p>添加收货地址</p>
    	</a>

    <a class="pay_btn" href="<?php echo U('Product/details', ['id' => $_GET['product_id']]);?>" style="display: block;width: 60%;margin: 0.5rem auto;text-align: center;height: 2rem;line-height: 2rem;font-size: 0.7rem;border-radius: 0.2rem; background-color:#f4a72f; color:#fff;">返回下单页</a>
